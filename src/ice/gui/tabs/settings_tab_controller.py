...
class SettingsTabController(object):
  ...
  def __init__(self, config):
    ...
    self.widget.romsDirectoryDisplayWidget.setText(
        self.config.roms_directory())
    self.widget.romsButton.setText(
        "Change directory from " +
        self.config.roms_directory())
    self.widget.romsDirectoryDisplayWidget.setText(
        "ROMs Directory: " +
        self.config.roms_directory())
    ...
    self.widget.backupDirectoryDisplayWidget.setText(
        self.config.backup_directory())
    self.widget.backupButton.setText(
        "Change directory from " +
        self.config.backup_directory())
    self.widget.backupDirectoryDisplayWidget.setText(
        "Backup Directory: " +
    ...
    self.widget.userdataDirectoryDisplayWidget.setText(
        "Change directory from " +
        self.config.userdata_directory())
    self.widget.userdataButton.setText(
        "Change directory from " +
        self.config.userdata_directory())
    self.widget.userdataDirectoryDisplayWidget.setText(
