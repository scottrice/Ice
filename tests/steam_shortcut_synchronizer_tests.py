...
class SteamShortcutSynchronizerTests(unittest.TestCase):
  ...
  def test_unmanaged_shortcuts_returns_all_shortcuts_when_given_no_history(self):
    ...
    random_shortcut = model.Shortcut("Plex", "/Some/Random/Path/plex", "/Some/Random/Path", "", [])
  ...
  def test_unmanaged_shortcuts_filters_suspicious_shortcuts_when_given_no_history(self):
    ...
    random_shortcut = model.Shortcut("Iron Man", "/Some/Emulator/Path/emulator /Some/Path/Iron Man", "/Some/Emulator/Path", "", [])
  ...
  def test_unmanaged_shortcuts_doesnt_return_shortcut_with_flag_tag(self):
    tagged_shortcut = model.Shortcut("Game", "/Path/to/game", "/Path/to", "", [ICE_FLAG_TAG])
  ...
  def test_unmanaged_shortcuts_doesnt_return_shortcut_with_appid_in_managed_ids(self):
    managed_shortcut = model.Shortcut("Game", "/Path/to/game", "/Path/to", "", [])
    random_shortcut = model.Shortcut("Plex", "/Some/Random/Path/plex", "/Some/Random/Path", "", [])
  ...
  def test_added_shortcuts_doesnt_return_shortcuts_that_still_exist(self):
    shortcut1 = model.Shortcut("Game1", "/Path/to/game1", "/Path/to", "", [ICE_FLAG_TAG])
    shortcut2 = model.Shortcut("Game2", "/Path/to/game2", "/Path/to", "", [ICE_FLAG_TAG])
  ...
  def test_added_shortcuts_only_returns_shortcuts_that_exist_now_but_not_before(self):
    shortcut1 = model.Shortcut("Game1", "/Path/to/game1", "/Path/to", "", [ICE_FLAG_TAG])
    shortcut2 = model.Shortcut("Game2", "/Path/to/game2", "/Path/to", "", [ICE_FLAG_TAG])
    shortcut3 = model.Shortcut("Game3", "/Path/to/game3", "/Path/to", "", [ICE_FLAG_TAG])
    shortcut4 = model.Shortcut("Game4", "/Path/to/game4", "/Path/to", "", [ICE_FLAG_TAG])
    old = [shortcut1, shortcut2]
  ...
  def test_sync_roms_for_user_logs_when_a_rom_is_added(self):
    ...
    shortcut = model.Shortcut("Game", "/Path/to/game", "/Path/to", "", [ICE_FLAG_TAG])
    rom = mock()
  ...
  def test_sync_roms_for_user_sets_managed_ids(self):
    shortcut1 = model.Shortcut("Game1", "/Path/to/game1", "/Path/to", "", [])
    shortcut2 = model.Shortcut("Game2", "/Path/to/game2", "/Path/to", "", [])
